# This R script reads the data and Plots inside file Plot1.png
...
ecs2$Time3<- as.POSIXct(ecs2$DT, format="%d/%m/%Y%H:%M:%S", tz="GMT")
hist(ecs2$Global_active_power, col="red",main=" Global Active Power", xlab = " Global Active Power (Kilowatts)")

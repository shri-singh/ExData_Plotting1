# This R script reads the data and Plots inside file Plot4.png
...
# Create Plot4 : 2*2 charts

par(mfrow=c(2,2))     # Set Margin Parameters to create four chars in the canvas
#----------Sub Plot1 
...
#-----------Sub Plot2
with(ecs2,plot(Time3,Voltage, type = "n",xlab = "datetime", ylab = "Voltage"))
with(ecs2,lines(Time3, Voltage))
...
#------------Sub Plot 4
with(ecs2,plot(Time3,Global_reactive_power, type = "n",xlab = "datetime", ylab = "Global_reactive_power"))
with(ecs2,lines(Time3, Global_reactive_power))
